...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Aalogics_Blog::Aalogicsmanageblog')
            ->addBreadcrumb(__('Aalogics Blog'), __('Aalogics Blog'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Aalogics\Blog\Model\Aalogicsmanageblog');
        ...
        $this->_coreRegistry->register('aalogicsmanageblog', $model);
